...
trait Playable {
  ...
  protected def sendNew(arguments: Seq[Object], deltaTime: Long)(implicit player: MusicPlayer) = {
    val theMessages: Array[Object] = arguments.toArray
    sendBundle(Array(new OSCMessage("/s_new", arguments.toArray)), deltaTime)(player)
  }

  protected def sendBundle(messages: Array[OSCPacket], deltaTime: Long)(implicit player: MusicPlayer) = {
